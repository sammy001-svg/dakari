-- =============================================================
-- Dakari — Fix missing orders columns
-- Run this once in phpMyAdmin on the live cPanel database.
-- All statements use IF NOT EXISTS so it is safe to re-run.
-- =============================================================

-- 1. Payment columns (from payment_migration.sql)
ALTER TABLE orders
...
-- 5. FK from orders.coupon_id → coupons (skip if already exists)
ALTER TABLE orders
